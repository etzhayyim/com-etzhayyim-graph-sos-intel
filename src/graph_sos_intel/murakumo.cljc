...
(defn collection
  [name]
  (str "com.etzhayyim.graph-sos-intel." name))

(def cell-specs {
  :health {:legacy-cell "com-etzhayyim-apps-graphSosIntel-health"
     :phase :event
  ...
  :listrelations {:legacy-cell "com-etzhayyim-apps-graphSosIntel-listRelations"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "listrelations")]
     :required-gates common-gates
     :trigger "manifest cell listrelations"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :listfindings {:legacy-cell "com-etzhayyim-apps-graphSosIntel-listFindings"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "listfindings")]
     :required-gates common-gates
     :trigger "manifest cell listfindings"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
